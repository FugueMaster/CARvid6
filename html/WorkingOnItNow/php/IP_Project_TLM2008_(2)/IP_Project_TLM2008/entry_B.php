  ...
  <!-- ======= Contact Section ======= -->
    <section class="contact" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
	  ...
	  <div class="col-lg-6">
              ...
              <form action="confirmationB.php" method="post" class="php-email-form" onsubmit="return checkForm(this);">
                <div class="form-row">
              ...
              <div class="form-group">
                <label>Enter lane number applicable for <b>vehicle breakdown</b> report.</label>
                  <input type="number" name="lane_no" placeholder="Lane number" min="0" data-rule="minlen:1" data-msg="Please enter lane number.">
                  <div class="validate"></div>
                <div class="validate"></div>
                <br><label>Enter car plate number of <b>breakdown vehicle</b></label>
                <input type="text" name="carplate" id="carplate" placeholder="Enter car plate number" data-rule="minlen:5" data-msg="Please enter car plate">
                <div class="validate"></div>
