    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          ...
          <a href="login.php" class="btn-get-started animated fadeInUp">Read More</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <a href="login.php" class="btn-get-started animated fadeInUp">Find out how</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <a href="login.php" class="btn-get-started animated fadeInUp">Submit now</a>
        </div>
      </div>
