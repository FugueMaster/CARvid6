 ...
 <!-- ======= Contact Section ======= -->    
  ...
  <!-- ======= Contact Section ======= -->
    <section class="contact" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
	  ...
	  <div class="col-lg-6">
              <form action="confirmationC.php" method="post" role="form" class="php-email-form">
              <div class="form-row">
              ...
              <div class="form-group">
                <label>Select <b>start date of road closure</b></label>
                    <input type="date" id="sc_date" data-rule="required" data-msg="Please select start date"><br>
                    <div class="validate"></div>
                    <label>Select <b>end date of road closure</b></label>
                    <input type="date" id="ec_date" data-rule="required" data-msg="Please select end date"><br> 
                    <div class="validate"></div>
